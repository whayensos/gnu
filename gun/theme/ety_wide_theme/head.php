...
<!-------------------------- 수정해서 사용하세욧 -------------------------->
<meta name="description" content="그누보드와 친해지기">
<meta property="og:type" content="website">
<meta property="og:title" content="친해지자 그누보드">
<meta property="og:description" content="그누보드와 친해지기">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div id="tnb">
					<ul>
					<?php if($is_member) { ?>
						<li><a href="<?php echo G5_URL?>/bbs/

              ut.php">로그아웃</a></li>

					<?php }else{ ?>
						<li><a href="<?php echo G5_URL?>/bbs/register.php"><i aria-hidden="true"></i> 이벤트 참여하기</a></li>
						<li><a href="<?php echo G5_URL?>/bbs/login.php"><i ></i> 로그인</a></li>
					<?php }?>
...
<nav class="navbar fixed-top navbar-expand-lg navbar-white bg-white fixed-top">
  <div class="container">
	<a class="navbar-brand" href="<?php echo G5_URL?>" class="logo"><img src="<?php echo G5_THEME_URL?>/img/clio.png"
