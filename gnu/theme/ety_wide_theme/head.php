		...
		<div class="row">
			<div class="col-md-12">
              ...
              ut.php">로그아웃</a></li>
					...
					<?php }else{ ?>
					<center><a href="<?php echo G5_URL?>/bbs/register.php"><i aria-hidden="true"></i> 리뷰 작성하기</a></li>
					<a href="<?php echo G5_URL?>/bbs/login.php"><i ></i>체험단 신청하러가기</a></li>
          <a href="<?php echo G5_URL?>/bbs/login.php"><i ></i>런칭 신청하러가기</a></li>
					<?php }?>
